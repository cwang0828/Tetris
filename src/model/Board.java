...
public class Board extends Observable {
    ...
    /**
     * 
     * @param theWidth is the setter for the Board width. 
     */
    public void setBoardWidth(final int theWidth) {
        myWidth = theWidth; 
    }

    /**
     * 
     * @param theHeight is the setter for the board height. 
     */
    public void setBoardHeight(final int theHeight) {
        myHeight = theHeight; 
    }
